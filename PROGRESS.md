...
- No-blockers fresh-agent finding: no release-blocking findings remain, but upload failure handling and folder-cap recovery need local wording polish before a 3 / 3 baseline scorecard.
...
- Polish upload cleanup and folder-cap recovery wording, then rerun fresh-agent dry validation before tagging a baseline.
