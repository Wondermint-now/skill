...
`/marketplace` for public content discovery. It must not include direct
marketplace workflows:

- buying or purchasing items
- publishing, unpublishing, or configuring sale terms
- purchase status, purchase history, access, downloads, or listing transactions
- marketplace analytics, market performance, exports, trends, or rankings
...
- `Variant: core`
- `Direct marketplace workflows included: no`
