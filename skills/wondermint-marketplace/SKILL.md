...
description: >
  ...
  handling marketplace buying, selling, orders, seller analytics, or payouts;
...
**Variant:** marketplace. This variant may include transactional marketplace
workflows such as buying, selling, orders, seller analytics, and payouts after
those endpoints have been documented and scored for this variant. The core
`wondermint` variant must not include those transactional workflows.
...
| Marketplace buying, selling, orders, analytics, payouts | [Marketplace Scope](skills/marketplace.md) |
...
| Use marketplace buying, selling, order, analytics, or payout workflows | [Marketplace Scope](skills/marketplace.md) |
