...
- **Can I upload ZIP files or asset bundles?** Current uploads support Image,
...
documented REST endpoints in the marketplace variant. Do not add auctions. Do
not add bids. Do not add offers.
...
- **What is Wondermint?** A creative platform to discover, collect, and sell
  ...
  art, and more. For marketplace agent guidance, use only documented REST
  endpoints and do not present auctions, bids, or offers.
